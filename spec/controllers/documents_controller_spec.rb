...
describe DocumentsController do
  ...
  let(:valid_attributes) { {first_spouse_first_name: 'hello'} }
  ...
  describe "GET index" do
    it "assigns all uses documents as @documents" do
      document = Document.new valid_attributes
      document.architect = user
      document.save
    ...
    it 'collection should be decorated' do
      document = Document.create! valid_attributes
      get :index, {}, valid_session
      assigns(:documents).should be_decorated
    end
  end

  describe "GET public_access" do
    before { sign_out }

    it 'responds 404 if doc not found' do
      get :public_access, key: 123
      expect(response.status).to eq 404
    end

    context 'with documents' do
      let!(:document) { create :document }
      let!(:link) { create :link, document: document }

      it 'render #show view' do
        get :public_access, key: link.key
  ...
  describe "GET show" do
    ...
    it 'assigned document should be decorated' do
      document = Document.create! valid_attributes
      get :show, {:id => document.to_param}, valid_session
      assigns(:document).should be_decorated
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      ...
      it 'creates a new document with architect' do
        post :create, {:document => valid_attributes}, valid_session
        expect(Document.first.architect).to eq user
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved document as @document" do
        ...
        post :create, {:document => { 'test' => 1 }}, valid_session
        assigns(:document).should be_a_new(Document)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested document and make active" do
        document = Document.create! valid_attributes
        ...
        Document.any_instance.should_receive(:update).with({ "second_spouse_first_name" => "params", "active" => true })
        put :update, {:id => document.to_param, :document => { "second_spouse_first_name" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the document as @document" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Document.any_instance.stub(:save).and_return(false)
        put :update, {:id => document.to_param, :document => { "test" => '123' }}, valid_session
        assigns(:document).should eq(document)
      end
